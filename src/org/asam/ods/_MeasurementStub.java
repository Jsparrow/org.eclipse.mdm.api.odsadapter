...
public class _MeasurementStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.asam.ods.Measurement
{
	...
	public final static java.lang.Class _opsClass = org.asam.ods.MeasurementOperations.class;
	public void setValue(org.asam.ods.NameValueUnit value) throws org.asam.ods.AoException
	{
		...
		else
		{
			...
			MeasurementOperations _localServant = (MeasurementOperations)_so.servant;
			try
			{
	...
	public org.asam.ods.ValueMatrix getValueMatrixInMode(org.asam.ods.ValueMatrixMode vmMode) throws org.asam.ods.AoException
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.getValueMatrixInMode(vmMode);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.asam.ods.ValueMatrix getValueMatrix() throws org.asam.ods.AoException
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.getValueMatrix();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void removeSMatLink(org.asam.ods.SMatLink smLink) throws org.asam.ods.AoException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "removeSMatLink", true);
				org.asam.ods.SMatLinkHelper.write(_os,smLink);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "removeSMatLink", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			MeasurementOperations _localServant = (MeasurementOperations)_so.servant;
			try
			{
				_localServant.removeSMatLink(smLink);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.asam.ods.SMatLink[] getSMatLinks() throws org.asam.ods.AoException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getSMatLinks", true);
				_is = _invoke(_os);
				org.asam.ods.SMatLink[] _result = org.asam.ods.SMatLinkSequenceHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getSMatLinks", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			MeasurementOperations _localServant = (MeasurementOperations)_so.servant;
			...
			try
			{
				_result = _localServant.getSMatLinks();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.asam.ods.SMatLink createSMatLink() throws org.asam.ods.AoException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "createSMatLink", true);
				_is = _invoke(_os);
				org.asam.ods.SMatLink _result = org.asam.ods.SMatLinkHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "createSMatLink", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			MeasurementOperations _localServant = (MeasurementOperations)_so.servant;
			org.asam.ods.SMatLink _result;
			try
			{
				_result = _localServant.createSMatLink();
			}
			finally
			{
				_servant_postinvoke(_so);
