...
public class _ElemResultSetExtSeqIteratorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.asam.ods.ElemResultSetExtSeqIterator
{
	private String[] ids = {"IDL:org/asam/ods/ElemResultSetExtSeqIterator:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.asam.ods.ElemResultSetExtSeqIteratorOperations.class;
	public org.asam.ods.ElemResultSetExt nextOne() throws org.asam.ods.AoException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				org.asam.ods.ElemResultSetExt _result = org.asam.ods.ElemResultSetExtHelper.read(_is);
				return _result;
			}
		...
		else
		{
			...
			ElemResultSetExtSeqIteratorOperations _localServant = (ElemResultSetExtSeqIteratorOperations)_so.servant;
	...
	public org.asam.ods.ElemResultSetExt[] nextN(int how_many) throws org.asam.ods.AoException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				org.asam.ods.ElemResultSetExt[] _result = org.asam.ods.ElemResultSetExtSequenceHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
