...
public final class SS_BYTESTRHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.asam.ods.SS_BYTESTRHelper.id(), "SS_BYTESTR",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.asam.ods.S_BYTESTRHelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:org/asam/ods/SS_BYTESTR:1.0";
	}
	public static byte[][][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new byte[_l_result23][][];
		for (int i=0;i<_result.length;i++)
		{
			_result[i] = org.asam.ods.S_BYTESTRHelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, byte[][][] _s)
	{
		...
		{
			org.asam.ods.S_BYTESTRHelper.write(_out,_s[i]);
		}
