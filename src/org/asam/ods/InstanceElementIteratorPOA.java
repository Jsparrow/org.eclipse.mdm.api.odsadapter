...
public abstract class InstanceElementIteratorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.asam.ods.InstanceElementIteratorOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.asam.ods.InstanceElementHelper.write(_out,nextOne());
			}
			...
			try
			{
				...
				_out = handler.createReply();
				org.asam.ods.InstanceElementSequenceHelper.write(_out,nextN(_arg0));
			}
			catch(org.asam.ods.AoException _ex0)
			{
				_out = handler.createExceptionReply();
