...
public final class SMatLinkHelper
{
	...
	{
		return narrow(in.read_Object(org.asam.ods._SMatLinkStub.class));
	}
	...
	public static org.asam.ods.SMatLink narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.asam.ods.SMatLink)
		{
			return (org.asam.ods.SMatLink)obj;
		}
		else if (obj._is_a("IDL:org/asam/ods/SMatLink:1.0"))
		{
