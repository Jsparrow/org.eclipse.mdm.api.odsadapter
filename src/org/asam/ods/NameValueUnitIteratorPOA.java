...
public abstract class NameValueUnitIteratorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.asam.ods.NameValueUnitIteratorOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.asam.ods.NameValueUnitHelper.write(_out,nextOne());
			}
			...
			try
			{
				...
				_out = handler.createReply();
				org.asam.ods.NameValueUnitSequenceHelper.write(_out,nextN(_arg0));
			}
			catch(org.asam.ods.AoException _ex0)
			{
				_out = handler.createExceptionReply();
