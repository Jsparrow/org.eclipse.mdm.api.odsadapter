...
public class SubMatrixPOATie
	extends SubMatrixPOA
{
	private SubMatrixOperations _delegate;

	private POA _poa;
	public SubMatrixPOATie(SubMatrixOperations delegate)
	{
		_delegate = delegate;
	}
	public SubMatrixPOATie(SubMatrixOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public SubMatrixOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(SubMatrixOperations delegate)
	{
		_delegate = delegate;
	}
