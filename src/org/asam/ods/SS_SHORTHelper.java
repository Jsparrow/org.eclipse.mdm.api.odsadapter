...
public final class SS_SHORTHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.asam.ods.SS_SHORTHelper.id(), "SS_SHORT",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.asam.ods.S_SHORTHelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:org/asam/ods/SS_SHORT:1.0";
	}
	public static short[][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new short[_l_result16][];
		for (int i=0;i<_result.length;i++)
		{
			_result[i] = org.asam.ods.S_SHORTHelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, short[][] _s)
	{
		...
		{
			org.asam.ods.S_SHORTHelper.write(_out,_s[i]);
		}
