...
public final class SS_FLOATHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.asam.ods.SS_FLOATHelper.id(), "SS_FLOAT",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.asam.ods.S_FLOATHelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:org/asam/ods/SS_FLOAT:1.0";
	}
	public static float[][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new float[_l_result17][];
		for (int i=0;i<_result.length;i++)
		{
			_result[i] = org.asam.ods.S_FLOATHelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, float[][] _s)
	{
		...
		{
			org.asam.ods.S_FLOATHelper.write(_out,_s[i]);
		}
