...
public class _NameValueUnitSequenceIteratorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.asam.ods.NameValueUnitSequenceIterator
{
	private String[] ids = {"IDL:org/asam/ods/NameValueUnitSequenceIterator:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.asam.ods.NameValueUnitSequenceIteratorOperations.class;
	public org.asam.ods.NameValueSeqUnit nextOne() throws org.asam.ods.AoException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				org.asam.ods.NameValueSeqUnit _result = org.asam.ods.NameValueSeqUnitHelper.read(_is);
				return _result;
			}
		...
		else
		{
			...
			NameValueUnitSequenceIteratorOperations _localServant = (NameValueUnitSequenceIteratorOperations)_so.servant;
