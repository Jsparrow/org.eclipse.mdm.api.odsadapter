...
public final class T_BYTESTRHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.asam.ods.T_BYTESTRHelper.id(), "T_BYTESTR",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.asam.ods.T_BYTEHelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:org/asam/ods/T_BYTESTR:1.0";
	}
