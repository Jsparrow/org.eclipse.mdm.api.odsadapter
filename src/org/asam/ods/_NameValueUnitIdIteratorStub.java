...
public class _NameValueUnitIdIteratorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.asam.ods.NameValueUnitIdIterator
{
	private String[] ids = {"IDL:org/asam/ods/NameValueUnitIdIterator:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.asam.ods.NameValueUnitIdIteratorOperations.class;
	public org.asam.ods.NameValueUnitId nextOne() throws org.asam.ods.AoException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				org.asam.ods.NameValueUnitId _result = org.asam.ods.NameValueUnitIdHelper.read(_is);
				return _result;
			}
		...
		else
		{
			...
			NameValueUnitIdIteratorOperations _localServant = (NameValueUnitIdIteratorOperations)_so.servant;
			org.asam.ods.NameValueUnitId _result;
			try
			{
	...
	public org.asam.ods.NameValueSeqUnitId nextN(int how_many) throws org.asam.ods.AoException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				org.asam.ods.NameValueSeqUnitId _result = org.asam.ods.NameValueSeqUnitIdHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
