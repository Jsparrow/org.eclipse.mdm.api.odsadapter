...
public final class SS_BOOLEANHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.asam.ods.SS_BOOLEANHelper.id(), "SS_BOOLEAN",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.asam.ods.S_BOOLEANHelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:org/asam/ods/SS_BOOLEAN:1.0";
	}
	public static boolean[][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new boolean[_l_result18][];
		for (int i=0;i<_result.length;i++)
		{
			_result[i] = org.asam.ods.S_BOOLEANHelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, boolean[][] _s)
	{
		...
		{
			org.asam.ods.S_BOOLEANHelper.write(_out,_s[i]);
		}
