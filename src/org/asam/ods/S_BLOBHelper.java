...
public final class S_BLOBHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.asam.ods.S_BLOBHelper.id(), "S_BLOB",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.asam.ods.T_BLOBHelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:org/asam/ods/S_BLOB:1.0";
	}
	public static org.asam.ods.Blob[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.asam.ods.Blob[_l_result24];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=org.asam.ods.BlobHelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, org.asam.ods.Blob[] _s)
	{
		...
		{
			org.asam.ods.BlobHelper.write(_out,_s[i]);
		}
