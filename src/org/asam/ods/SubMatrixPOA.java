...
public abstract class SubMatrixPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.asam.ods.SubMatrixOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "setValueSeq", new java.lang.Integer(9));
		m_opsHash.put ( "renameInstanceAttribute", new java.lang.Integer(10));
		m_opsHash.put ( "getRelatedInstances", new java.lang.Integer(11));
		m_opsHash.put ( "createRelatedInstances", new java.lang.Integer(12));
		m_opsHash.put ( "getName", new java.lang.Integer(13));
		m_opsHash.put ( "getInitialRights", new java.lang.Integer(14));
		m_opsHash.put ( "deepCopy", new java.lang.Integer(15));
		m_opsHash.put ( "getColumns", new java.lang.Integer(16));
		m_opsHash.put ( "addInstanceAttribute", new java.lang.Integer(17));
		m_opsHash.put ( "getAsamPath", new java.lang.Integer(18));
		m_opsHash.put ( "getRelatedInstancesByRelationship", new java.lang.Integer(19));
		m_opsHash.put ( "destroy", new java.lang.Integer(20));
		m_opsHash.put ( "getId", new java.lang.Integer(21));
		m_opsHash.put ( "removeInstanceAttribute", new java.lang.Integer(22));
		m_opsHash.put ( "getRights", new java.lang.Integer(23));
		m_opsHash.put ( "listColumns", new java.lang.Integer(24));
		...
		m_opsHash.put ( "listRelatedInstancesByRelationship", new java.lang.Integer(31));
		m_opsHash.put ( "listRelatedInstances", new java.lang.Integer(32));
		m_opsHash.put ( "getValue", new java.lang.Integer(33));
		m_opsHash.put ( "setInitialRights", new java.lang.Integer(34));
		m_opsHash.put ( "upcastODSFile", new java.lang.Integer(35));
		m_opsHash.put ( "setName", new java.lang.Integer(36));
	}
	private String[] ids = {"IDL:org/asam/ods/SubMatrix:1.0","IDL:org/asam/ods/InstanceElement:1.0"};
	public org.asam.ods.SubMatrix _this()
	{
		return org.asam.ods.SubMatrixHelper.narrow(_this_object());
	}
	public org.asam.ods.SubMatrix _this(org.omg.CORBA.ORB orb)
	{
		return org.asam.ods.SubMatrixHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 10: // renameInstanceAttribute
			{
			try
			{
				java.lang.String _arg0=_input.read_string();
			...
			case 12: // createRelatedInstances
			{
			try
			{
				org.asam.ods.ApplicationRelation _arg0=org.asam.ods.ApplicationRelationHelper.read(_input);
			...
			case 19: // getRelatedInstancesByRelationship
			{
			try
			{
			...
			case 22: // removeInstanceAttribute
			{
			try
			{
				java.lang.String _arg0=_input.read_string();
			...
			case 31: // listRelatedInstancesByRelationship
			{
			try
			{
				org.asam.ods.Relationship _arg0=org.asam.ods.RelationshipHelper.read(_input);
