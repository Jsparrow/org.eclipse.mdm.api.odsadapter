...
public final class S_STRINGHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.asam.ods.S_STRINGHelper.id(), "S_STRING",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.asam.ods.T_STRINGHelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:org/asam/ods/S_STRING:1.0";
	}
