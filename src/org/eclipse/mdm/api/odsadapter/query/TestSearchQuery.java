...
final class TestSearchQuery extends AbstractDataItemSearchQuery {

	public TestSearchQuery(ODSQueryService queryService, ContextState contextState) {
		super(queryService, Test.class, Test.class /* TODO: Change to Project */, Optional.of(contextState));
